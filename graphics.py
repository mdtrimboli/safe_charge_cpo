...
t_curves_i = open('curves/T_wSL.csv', 'rb')
v_curves = open('curves/V_wSL.csv', 'rb')
i_curves = open('curves/I_wSL.csv', 'rb')
soc_curves = open('curves/SOC_wSL.csv', 'rb')
